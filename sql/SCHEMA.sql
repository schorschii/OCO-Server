...
CREATE TABLE IF NOT EXISTS `computer` (
  ...
  `agent_timestamp` DOUBLE NOT NULL DEFAULT '0',
  `notes` text NOT NULL,
...
CREATE TABLE `domain_user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_domain_user_group_id` int(11) NULL DEFAULT NULL,
  `name` text NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_domain_user_group_1` FOREIGN KEY (`parent_domain_user_group_id`) REFERENCES `domain_user_group`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
