...
foreach($domainuser as $u) {
	...
	echo "<td><a href='".explorerLink('views/domainuser_detail.php?id='.$u->id)."' onclick='event.preventDefault();refreshContentDomainuserDetail(\"".$u->id."\")'>".htmlspecialchars($u->username)."</a></td>";
