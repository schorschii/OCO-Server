...
<div class='details-header'>
	...
	<div class='controls'>
		<button onclick='showDialogAjax(L__EDIT_REPORT, "views/dialog-report-update.php", DIALOG_BUTTONS_CLOSE, DIALOG_SIZE_AUTO, function(){ txtEditReportId.value="<?php echo $report->id; ?>"; txtEditReportName.value=spnReportName.innerText; txtEditReportNotes.value=spnReportNotes.innerText; txtEditReportQuery.value=spnReportQuery.innerText; })'><img src='img/edit.svg'>&nbsp;<?php echo LANG['edit']; ?></button>
