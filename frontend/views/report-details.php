	...
	<div class='stickytable'>
		...
		foreach($results as $result) {
			...
			foreach($result as $key => $value) {
				if($key == 'computer_id') {
					$hasComputerIds = true;
					echo "<td><a ".Html::explorerLink('views/computer-details.php?id='.intval($value)).">".htmlspecialchars($value)."</a></td>";
					...
					echo "<td><a ".Html::explorerLink('views/mobile-device-details.php?id='.intval($value)).">".htmlspecialchars($value)."</a></td>";
				} elseif($key == 'app_id') {
					echo "<td><a ".Html::explorerLink('views/apps.php?id='.intval($value)).">".htmlspecialchars($value)."</a></td>";
				} elseif($key == 'report_id') {
					echo "<td><a ".Html::explorerLink('views/report-details.php?id='.intval($value)).">".htmlspecialchars($value)."</a></td>";
