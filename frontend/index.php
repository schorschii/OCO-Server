...
<div id='container'>
	...
	<div id='header'>
		...
		<span class='search'>
			<input type='text' autocomplete='new-password' placeholder='<?php echo LANG['search_computer_packages_job_container']; ?>' onfocus='openSearchResults()' onkeyup='if(event.keyCode==27) {closeSearchResults();} else {doSearch(this.value);}' onpaste='doSearch(this.value)'>
