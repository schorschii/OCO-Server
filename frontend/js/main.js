...
function deploy(title, start, end, description, sltComputer, sltComputerGroup, sltPackage, sltPackageGroup, useWol, autoCreateUninstallJobs, doNotUninstallSameVersion, restartTimeout, sequenceMode, priority) {
	...
	formData.append('do_not_uninstall_same_version', doNotUninstallSameVersion ? 1 : 0);
