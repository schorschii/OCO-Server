...
const LANG = [
	...
	'purge_succeeded_jobs_after' => 'Lösche erfolgreiche Jobcontainer nach (Sekunden)',
	'purge_failed_jobs_after' => 'Lösche fehlgeschlagene Jobcontainer nach (Sekunden)',
	...
	'force_installation_of_same_version' => 'Installationsjobs anlegen, selbst wenn die gleiche Version bereits installiert ist (neu installieren)',
	...
	'purge_domain_user_logons_after' => 'Domänenbenutzer-Anmeldungen löschen nach (Sekunden)',
	...
	'package_creation_notes' => '
		...
		<p>
			...
			<ul>
				...
				<li>.app-Verzeichnis für macOS aus DMG-Datei: <code>hdiutil attach myprogram.dmg && cp -R /Volumes/myprogram/myprogram.app /Applications && hdiutil detach /Volumes/myprogram</code></li>
				<li>.app-Verzeichnis für macOS deinstallieren: <code>rm -R /Applications/myprogram.app</code></li>
