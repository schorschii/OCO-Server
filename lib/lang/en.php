...
const LANG = [
	...
	'force_installation_of_same_version' => 'Create installation jobs even if the same version is already installed (reinstall)',
	...
	'hours' => 'Hour(s)',
	'minutes' => 'Minute(s)',
	'purge_logs_after' => 'Purge log entries after (seconds)',
	'purge_domain_user_logons_after' => 'Purge domain user logons after (seconds)',
	...
	'package_creation_notes' => '
		...
		<p>
			...
			<ul>
				...
				<li>.app directory for macOS from DMG file: <code>hdiutil attach myprogram.dmg && cp -R /Volumes/myprogram/myprogram.app /Applications && hdiutil detach /Volumes/myprogram</code></li>
				<li>.app directory for macOS uninstallation: <code>rm -R /Applications/myprogram.app</code></li>
